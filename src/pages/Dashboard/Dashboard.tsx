...
const Dashboard = () => {
    return (
        <section className="max-w-7xl mx-auto grid grid-cols-12 h-full gap-2">
            <div className="col-span-2 lg:col-span-3 bg-gray-300 h-full min-h-[100vh] py-10 pl-2 lg:pl-5 flex flex-col gap-7">

                <h1 className="text-center text-2xl md:text-3xl font-bold"><Link to="/">Event <span className="logo-style">360</span></Link></h1>
                <p className="text-center font-bold text-2xl">Admin Panel</p>
